...
你可以有自己的理解，包括你认为第一维世界是物质（XYZ)，第一维世界是意识，第一维世界是时间。都没关系。没有所谓的绝对正确，只有个人的选择。对于我来说，当前世界只是一个超强的虚幻引擎。人的一生只是一本书，我的一生只是一个RPG角色扮演游戏，大部分局中人（player）只是符合大数规律的NPC。所有的法律只不过是一种局部世界的基准规则。
